...
class OrdersRepositoryInterface(ABC):
    ...
    @abstractmethod
    def select_if_property_exists(self, doc_filter: str) -> dict: pass
    ...
    @abstractmethod
    def edit_registry_with_increment(self, object_id: str) -> None: pass

    @abstractmethod
    def delete_registry(self, object_id: str) -> None: pass

    @abstractmethod
    def delete_many_registry(self) -> None: pass
